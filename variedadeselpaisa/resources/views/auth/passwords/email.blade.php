        ...
        <div class="wrapper-page">
            ...
            <div class="m-t-80 card-box">
                <div class="text-center">
                    ...
                    <p class="text-muted m-b-0 font-13 m-t-20">Ingrese su correo electrónico y le enviaremos un mensaje con instrucciones para restablecer la contraseña.  </p>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal m-t-20" method="post" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group">
                             <div class="col-md-12">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="Ingresar email" required>
                        ...
                        <div class="form-group text-center m-t-20 m-b-0">
                            <div class="col-xs-12">
                                <button class="btn btn-custom btn-bordred btn-block waves-effect waves-light" type="submit">Enviar Email</button>
                            </div>
                        </div>
                        <div class="form-group text-center m-t-20 m-b-0">
                            <div class="col-xs-12">
                                <a href="../clientes" class="btn btn-custom btn-bordred btn-block waves-effect waves-light" type="submit">Regresar</a>
                            </div>
                        </div>
