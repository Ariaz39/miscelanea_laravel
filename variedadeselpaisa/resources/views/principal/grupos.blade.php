@extends('layouts.app')
@section('pestana','Grupos')
@section('content')
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">

            <h4 class="header-title m-t-0 m-b-30">Crear Grupo</h4>

            <div class="row">
                <form class="form-horizontal col-md-12" role="form" action="{{Route('grupos.store')}}" method="post">
                    @csrf
                    <div class="col-lg-12">
                        <div class="form-group col-md-6">
                            <label class="col-md-2 control-label">Nombre</label>
                            <div class="col-md-10">
                                <input type="text" id="name-grupo" name="nombre" class="form-control" placeholder="Escribir Nombre de Grupo">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-body">
                <h4 class="header-title m-t-0 m-b-30">Lista Grupos</h4>
                        ...
                        <tbody>
                            @foreach($grupos as $key)
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="{{Route('grupos.edit',$key->id)}}"><i class="fa fa-pencil"></i></a>
                                    </td>
                                </tr>
                            @endforeach
